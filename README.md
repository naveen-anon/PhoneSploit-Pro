...
<p align="center">
  ...
  <img alt="Platform" src="https://img.shields.io/badge/Platform-Linux%20%7C%20Windows%20%7C%20Termux-black">
  <img alt="License" src="https://img.shields.io/badge/Use-Authorized%20Only-green">
</p>
...
Make sure all the [required](https://github.com/naveen-anon/PhoneSploit-Pro#requirements) software are installed.

Open terminal and paste the following commands : 
```
git clone https://github.com/naveen-anon/PhoneSploit-Pro.git
```
```
cd PhoneSploit-Pro/
```
...
Open terminal and paste the following commands : 
```
git clone https://github.com/naveenhanon/PhoneSploit-Pro.git
```
```
cd PhoneSploit-Pro/
```
...
<a href="https://github.com/naveen-anon/">


**naveen-anon** - [@naveen-anon](https://github.com/naveen-anon/)
 

# Support Me
If you like my work you can support 
give a star ⭐ for this repository 

Copyright © 2030 naveen anon (github.com/naveen-anon)
